...
public class MyDB : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        if (dBType == "SqlServer")
        {
            ...
            optionsBuilder.ReplaceService<IQuerySqlGeneratorFactory, SqlServerNolockFactory>();
        }
        else if (dBType == "MySql") optionsBuilder.UseMySql(sqlstr, new MariaDbServerVersion(new Version(10, 5, 10)));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        foreach (Type tableType in Assembly.Load("MyDbEntity").GetTypes().Where(l => l.Namespace == "MyDbEntity.Tables").Where(l => l.BaseType?.BaseType == typeof(DbBase) || l.BaseType?.BaseType?.BaseType == typeof(DbBase)).ToArray())
