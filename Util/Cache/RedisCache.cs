...
public class RedisCache : ICache
{
    ...
    {
        SetCacheTemp(key, value, null, null);
    }

    public void SetCache(string key, object value, TimeSpan timeout)
    {
        SetCacheTemp(key, value, timeout, ExpireType.Absolute);
    }

    public void SetCache(string key, object value, TimeSpan timeout, ExpireType expireType)
    {
        SetCacheTemp(key, value, timeout, expireType);
    }

    private void SetCacheTemp(string key, object value, TimeSpan? timeout, ExpireType? expireType)
    {
